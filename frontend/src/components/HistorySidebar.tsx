            ...
            isOpen && (
                <> {/* Backdrop */}
                    <motion.div initial={
                        ...
                        onClick={onClose}
                        className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60]"/> {/* Sidebar */}
                    <motion.div initial={
                            {x: '-100%'}
                        }
                        animate={
                                ...
                                <motion.div key={
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="flex items-center gap-2 pt-1">
                                            ...
                                            <button onClick={
                                                    () => link.shortUrl && handleCopy(link.shortUrl, link.shortId)
                                                }
                                                className={
                                                    `flex-1 flex items-center justify-center gap-2 p-2 rounded-xl border font-semibold transition-all cursor-pointer text-xs
                                                     ${
                                                        copiedId === link.shortId ? 'bg-green-500/10 border-green-500/20 text-green-400' : 'bg-blue-600/10 border-blue-600/20 text-blue-400 hover:bg-blue-600/20'
                                                    }`
                                            }>
                                                {
